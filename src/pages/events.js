          ...
          <div className="event-box">
            <Container>
              ...
              <Container as="div" className="event-card">
                ...
                >
                  <h3 className="head-text">Highland Coffees Reading Series</h3>
                </a>
              ...
              <Container className="event-card">
                ...
                >
                  <h3 className="head-text"> Legend-LARPing Costume Party </h3>
                </a>
                <Container className="event-card-text">
                  <p>
                    Come dressed as your favorite literary icon. Details coming
                    soon!
                  </p>
                </Container>
              </Container>
